...
var _c04 = ["stripeElement"];
var _c13 = ["paypalButtonContainer"];
var _forTrack0 = ($index, $item) => $item.id;
function CheckoutComponent_Conditional_42_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 32);
    \u0275\u0275element(1, "mat-spinner", 34);
    \u0275\u0275elementStart(2, "span");
    \u0275\u0275text(3, "Loading payment form...");
    \u0275\u0275elementEnd()();
  }
}
function CheckoutComponent_Conditional_42_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
...
function CheckoutComponent_Conditional_42_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-card", 21)(1, "h4");
    \u0275\u0275text(2, "Card Details");
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, CheckoutComponent_Conditional_42_Conditional_3_Template, 4, 0, "div", 32);
    \u0275\u0275element(4, "div", null, 1);
    \u0275\u0275template(6, CheckoutComponent_Conditional_42_Conditional_6_Template, 2, 1, "p", 33);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    \u0275\u0275conditional(ctx_r1.stripeLoading ? 3 : -1);
    \u0275\u0275advance(3);
    \u0275\u0275conditional(ctx_r1.stripeError ? 6 : -1);
  }
}
function CheckoutComponent_Conditional_43_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 32);
    \u0275\u0275element(1, "mat-spinner", 34);
    \u0275\u0275elementStart(2, "span");
    \u0275\u0275text(3, "Loading PayPal...");
    \u0275\u0275elementEnd()();
  }
}
function CheckoutComponent_Conditional_43_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 33);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function CheckoutComponent_Conditional_43_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-card", 21)(1, "h4");
    \u0275\u0275text(2, "PayPal");
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, CheckoutComponent_Conditional_43_Conditional_3_Template, 4, 0, "div", 32);
    \u0275\u0275element(4, "div", null, 2);
    \u0275\u0275template(6, CheckoutComponent_Conditional_43_Conditional_6_Template, 2, 1, "p", 33);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    \u0275\u0275conditional(ctx_r1.paypalLoading ? 3 : -1);
    \u0275\u0275advance(3);
    \u0275\u0275conditional(ctx_r1.paypalError ? 6 : -1);
  }
}
function CheckoutComponent_For_58_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate2("", item_r3.product.name, " x ", item_r3.quantity, "");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(5, 3, item_r3.subtotal));
  }
}
function CheckoutComponent_Conditional_66_Template(rf, ctx) {
  if (rf & 1) {
...
var CheckoutComponent = class _CheckoutComponent {
  constructor(fb, cart, orderService, paymentService, router, snackBar) {
    this.fb = fb;
    this.cart = cart;
  ...
  ngAfterViewChecked() {
    if (this.stripeElementRef?.nativeElement && !this.stripeMounted && !this.stripeMountRequested && this.paymentForm.get("paymentMethod")?.value === "stripe") {
      this.initStripeElement();
    }
    if (this.paypalButtonContainerRef?.nativeElement && !this.paypalMounted && !this.paypalMountRequested && this.paymentForm.get("paymentMethod")?.value === "paypal") {
    ...
    paypal.Buttons({
      ...
      onApprove: (data, _actions) => {
        ...
        this.paymentService.capturePayPalOrder(data.orderID).subscribe({
          next: (res) => {
            ...
            this.submitOrder(captureId, () => {
              ...
              this.paymentService.confirmPayPalPayment(orderNumber, captureId).subscribe({
                next: () => {
                  this.processingPayment = false;
                  this.snackBar.open("Order placed successfully!", "Close", { duration: 5e3 });
          ...
          error: (err) => {
            this.processingPayment = false;
            this.snackBar.open(err.error?.message || "PayPal capture failed", "Close", { duration: 5e3 });
          }
        });
      },
      onError: (err) => {
  ...
  processStripePayment() {
    if (!this.stripe || !this.elements || !this.paymentIntentId) {
      this.snackBar.open("Payment form not ready. Please wait and try again.", "Close", { duration: 5e3 });
      this.loading = false;
      return;
    }
  ...
  confirmStripePayment() {
    return __async(this, null, function* () {
      ...
      if (error) {
        this.loading = false;
        this.snackBar.open(error.message || "Payment failed. Your order will be updated automatically.", "Close", { duration: 5e3 });
        ...
        if (paymentIntent.status === "succeeded" || paymentIntent.status === "processing" || paymentIntent.status === "requires_capture") {
          const msg = paymentIntent.status === "succeeded" ? "Order placed successfully!" : "Payment is being processed. Your order will be confirmed shortly.";
          this.snackBar.open(msg, "Close", { duration: 5e3 });
          this.router.navigate(["/orders", this.savedOrderNumber]);
        } else {
          this.loading = false;
          this.snackBar.open("Payment was not completed. Please try again.", "Close", { duration: 5e3 });
        }
      } else {
        this.loading = false;
        this.snackBar.open("Payment was not completed. Please try again.", "Close", { duration: 5e3 });
  ...
  submitOrder(paymentId, onOrderCreated) {
    const request = __spreadValues(__spreadProps(__spreadValues({}, this.shippingForm.value), {
    ...
    this.orderService.createOrder(request).subscribe({
      ...
      error: (err) => {
        this.loading = false;
        this.snackBar.open(err.error?.message || "Order failed", "Close", { duration: 5e3 });
      }
    });
  }
  static {
    this.\u0275fac = function CheckoutComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _CheckoutComponent)(\u0275\u0275directiveInject(FormBuilder), \u0275\u0275directiveInject(CartService), \u0275\u0275directiveInject(OrderService), \u0275\u0275directiveInject(PaymentService), \u0275\u0275directiveInject(Router), \u0275\u0275directiveInject(MatSnackBar));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CheckoutComponent, selectors: [["app-checkout"]], viewQuery: function CheckoutComponent_Query(rf, ctx) {
    ...
    }, standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 72, vars: 14, consts: [["stepper", ""], ["stripeElement", ""], ["paypalButtonContainer", ""], [1, "container", "checkout-container"], ["linear", ""], ["label", "Shipping", 3, "stepControl"], [3, "formGroup"], ["appearance", "outline", 1, "full-width"], ["matInput", "", "formControlName", "shippingAddress"], [1, "row"], ["appearance", "outline"], ["matInput", "", "formControlName", "shippingCity"], ["matInput", "", "formControlName", "shippingState"], ["matInput", "", "formControlName", "shippingZipCode"], ["matInput", "", "formControlName", "shippingCountry"], ["mat-raised-button", "", "color", "primary", "matStepperNext", "", 3, "disabled"], ["label", "Payment"], ["formControlName", "paymentMethod", 1, "payment-options"], ["value", "stripe"], ["value", "paypal"], ["value", "cod"], [1, "card-form"], ["matInput", "", "formControlName", "notes", "rows", "3"], [1, "step-actions"], ["mat-button", "", "matStepperPrevious", ""], ["label", "Review & Place Order"], [1, "order-summary"], [1, "summary-item"], [1, "summary-item", "total"], [1, "processing-overlay"], ["mat-button", "", "matStepperPrevious", "", 3, "disabled"], ["mat-raised-button", "", "color", "primary", 3, "click", "disabled"], [1, "stripe-loading"], [1, "stripe-error"], ["diameter", "24"], ["diameter", "40"]], template: function CheckoutComponent_Template(rf, ctx) {
      if (rf & 1) {
        const _r1 = \u0275\u0275getCurrentView();
        \u0275\u0275elementStart(0, "div", 3)(1, "h1");
        \u0275\u0275text(2, "Checkout");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(3, "mat-stepper", 4, 0)(5, "mat-step", 5)(6, "form", 6)(7, "mat-form-field", 7)(8, "mat-label");
        \u0275\u0275text(9, "Address");
        \u0275\u0275elementEnd();
        ...
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(20, "div", 9)(21, "mat-form-field", 10)(22, "mat-label");
        \u0275\u0275text(23, "ZIP Code");
        \u0275\u0275elementEnd();
        ...
        \u0275\u0275text(30, " Continue to Payment ");
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(31, "mat-step", 16)(32, "form", 6)(33, "h3");
        \u0275\u0275text(34, "Select Payment Method");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(35, "mat-radio-group", 17)(36, "mat-radio-button", 18);
        \u0275\u0275text(37, "Credit/Debit Card (Stripe)");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(38, "mat-radio-button", 19);
        \u0275\u0275text(39, "PayPal");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(40, "mat-radio-button", 20);
        \u0275\u0275text(41, "Cash on Delivery");
        \u0275\u0275elementEnd()();
        \u0275\u0275template(42, CheckoutComponent_Conditional_42_Template, 7, 2, "mat-card", 21)(43, CheckoutComponent_Conditional_43_Template, 7, 2, "mat-card", 21);
        \u0275\u0275elementStart(44, "mat-form-field", 7)(45, "mat-label");
        \u0275\u0275text(46, "Order Notes (optional)");
        \u0275\u0275elementEnd();
        ...
        \u0275\u0275text(52, " Review Order ");
        \u0275\u0275elementEnd()()()();
        \u0275\u0275elementStart(53, "mat-step", 25)(54, "mat-card", 26)(55, "h3");
        \u0275\u0275text(56, "Order Summary");
        \u0275\u0275elementEnd();
        \u0275\u0275repeaterCreate(57, CheckoutComponent_For_58_Template, 6, 5, "div", 27, _forTrack0);
        \u0275\u0275element(59, "hr");
        ...
        \u0275\u0275pipe(65, "currency");
        \u0275\u0275elementEnd()()();
        \u0275\u0275template(66, CheckoutComponent_Conditional_66_Template, 4, 0, "div", 29);
        \u0275\u0275elementStart(67, "div", 23)(68, "button", 30);
        \u0275\u0275text(69, "Back");
        \u0275\u0275elementEnd();
      ...
      if (rf & 2) {
        ...
        let tmp_6_0;
        \u0275\u0275advance(5);
        \u0275\u0275property("stepControl", ctx.shippingForm);
        \u0275\u0275advance();
        \u0275\u0275property("formGroup", ctx.shippingForm);
        \u0275\u0275advance(23);
        \u0275\u0275property("disabled", ctx.shippingForm.invalid);
        \u0275\u0275advance(3);
        \u0275\u0275property("formGroup", ctx.paymentForm);
        \u0275\u0275advance(10);
        \u0275\u0275conditional(((tmp_5_0 = ctx.paymentForm.get("paymentMethod")) == null ? null : tmp_5_0.value) === "stripe" ? 42 : -1);
        \u0275\u0275advance();
        \u0275\u0275conditional(((tmp_6_0 = ctx.paymentForm.get("paymentMethod")) == null ? null : tmp_6_0.value) === "paypal" ? 43 : -1);
        \u0275\u0275advance(8);
        \u0275\u0275property("disabled", !ctx.isPaymentStepValid());
        \u0275\u0275advance(6);
        \u0275\u0275repeater(ctx.cart.items());
        \u0275\u0275advance(7);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(65, 12, ctx.cart.total()));
        \u0275\u0275advance(2);
        \u0275\u0275conditional(ctx.processingPayment ? 66 : -1);
        \u0275\u0275advance(2);
        \u0275\u0275property("disabled", ctx.loading);
        \u0275\u0275advance(2);
        \u0275\u0275property("disabled", ctx.loading);
        \u0275\u0275advance();
        \u0275\u0275textInterpolate1(" ", ctx.loading ? "Placing Order..." : "Place Order", " ");
      }
    }, dependencies: [
      ReactiveFormsModule,
      \u0275NgNoValidate,
...
//# sourceMappingURL=chunk-ODZ2NITZ.js.map
